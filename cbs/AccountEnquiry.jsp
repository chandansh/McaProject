...
<tr>
  ...
  <tr>
    ...
    <tr><td align="center" height="30px" bgcolor="#E3E3FD">Account Enquiry</tr>
    ...
    <tr><td align="center" height="30px"><a href="IssueATM.jsp">Issue ATM card</a></tr>
        ...
        <div align="center">
          ...
          function validate()
          {
          	if(document.AccEnqFrm.acc_no.value=="")
          	{
          	alert("please enter account no");
          	return;
          	}
          	var myurl="ShowAccountEnquiry.jsp?acc_no="+document.AccEnqFrm.acc_no.value+"&acc_type="+document.AccEnqFrm.acc_type.value;
          ...
          <div align="center">
            <center>
            <form name="AccEnqFrm">
            <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#0F57BB" width="591" height="74">
              <tr>
                <th width="589" colspan="2" bgcolor="#0F57BB" height="18" >
                &nbsp;</th>
              </tr>
              <tr>
                <td width="290" align="left" height="18">Enter Account No</td>
                <td width="298" align="left" height="18">
                <input type="text" name="acc_no" size="20"></td>
              </tr>
              <tr>
                <td width="290" align="left" height="17">Select Account Type</td>
                <td width="298" align="left" height="17">
              ...
              <tr>
                <td width="290" align="left" height="18"></td>
                <td width="298" align="left" height="18"></td>
              </tr>
              <tr>
                <td width="290" align="left" height="18"></td>
                <td width="298" align="left" height="18">
                <input type="button" value="View Account" name="B1" onclick="validate();"></td>
              </tr>
              <tr>
                <td width="290" align="left" height="18"></td>
                <td width="298" align="left" height="18"></td>
