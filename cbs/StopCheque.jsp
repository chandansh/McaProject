...
<tr>
  ...
  <tr>
    ...
    <tr><td align="center" height="30px" bgcolor="#E3E3FD">Stop Cheque</tr>
    <tr><td align="center" height="30px"><a href="IssueATM.jsp">Issue ATM card</a></tr>
        ...
        <div align="center">
          <center>
          <%
          String s_acc_no=request.getParameter("acc_no");
          String s_cheque_no=request.getParameter("cheque_no");
          if(s_acc_no!=null && s_acc_no!="")
          {
          		try
				{
				conn = bean.getConnection(request);
				PreparedStatement stat= conn.prepareStatement("select a.*,b.* from branch as a,cheque_issue_details as b where a.ifs_code=b.ifs_code and a.branch_id=? and b.account_no=? and b.cheque_no=?");
				stat.setString(1,branch);
				stat.setString(2,s_acc_no);
				stat.setString(3,s_cheque_no);

				rs = stat.executeQuery();
		
				if(rs.next())	
				{
					if(rs.getString("cheque_status").equals("issued"))
					{
					PreparedStatement stat1= conn.prepareStatement("update cheque_issue_details set cheque_status='stoped' where cheque_no=?");
					stat1.setString(1,s_cheque_no);
					stat1.executeUpdate();
					out.print("<font color='green'>Account no :"+s_acc_no+"<br>Cheque is stoped cheque no:"+s_cheque_no+"</font>");
					}
					else
					{
					out.print("<font color='red'>Cheque is cleared or already stoped</font>");
					}
				}
				else
				{
				out.print("<font color='red'>Cheque not issued on this account no</font>");
				}
				}//ed of try
				catch(Exception E)
				{
          ...
          function validate()
          {
          	if(document.stop_cheque.acc_no.value=="")
          	{
          	alert("please enter account no");
          	return;
          	}
          	var myurl="ShowAccountEnquiry.jsp?acc_no="+document.stop_cheque.acc_no.value+"&acc_type="+document.stop_cheque.acc_type.value;
          ...
          function validate1()
          {
          	...
          	if(document.stop_cheque.cheque_no.value=="")
          	{
            ...
            <form name="stop_cheque" method="post">
            <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#0F57BB" width="56%">
              ...
              <tr>
                <td width="34%" align="left">Enter Account No</td>
                <td width="66%" align="left">
                <input type="text" name="acc_no" size="20"></td>
              </tr>
              
              <tr>
                <td width="34%" align="left">Select Account Type</td>
                <td width="66%" align="left"><select size="1" name="acc_type">
              <option selected value="sb">Saving Account</option>
              <option value="ca">Current Account</option>
              </select>
              <input type="button" value="Enquiry Account" name="B2" onclick="validate();"></td>
              </tr>
              
              <tr>
                <td width="34%" align="left">Enter cheque No</td>
                <td width="66%" align="left">
              ...
              <tr>
                ...
                <td width="66%" align="left">
                <input type="submit" value="Transmit" name="B1" onclick="validate1();">
