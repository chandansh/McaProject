...
&nbsp;<%	
		...
		finally
		{
          ...
          %> <b>Branch Account</b><div align="center">
            <center>
            <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#0F57BB" width="90%">
              <tr>
                <th width="20%" bgcolor="#0F57BB" bordercolor="#0F57BB">
                <font color="#FFFFFF">Account no</font></th>
                <th width="20%" bgcolor="#0F57BB" bordercolor="#0F57BB">
                <font color="#FFFFFF">Account name</font></th>
                <th width="20%" bgcolor="#0F57BB" bordercolor="#0F57BB">
                <font color="#FFFFFF">Branch Id</font></th>
                <th width="20%" bgcolor="#0F57BB" bordercolor="#0F57BB">
                <font color="#FFFFFF">open date</font></th>
                <th width="20%" bgcolor="#0F57BB" bordercolor="#0F57BB">
                <font color="#FFFFFF">balance</font></th>
              </tr>
              <%
              try
				{
				conn = bean.getConnection(request);
				PreparedStatement stat= conn.prepareStatement("select * from branch_account where branch_id=?");
                ...
                %>
              <tr>
                <td width="20%">&nbsp;<%=rs.getString("account_no")%></td>
                <td width="20%">&nbsp;<%=rs.getString("account_name")%></td>
                <td width="20%">&nbsp;<%=rs.getString("branch_id")%></td>
                <td width="20%">&nbsp;<%=rs.getString("account_open_date")%></td>
                <td width="20%">&nbsp;<%=rs.getString("balance")%></td>
              </tr>
              <%	
				}//en of while		
