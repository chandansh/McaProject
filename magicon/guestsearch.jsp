...
<table border="1" cellspacing="0" width="90%" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" style="border-collapse: collapse" cellpadding="0">
            <tr>
...
try
		...
		%>
            ...
            <tr>
              <td width="9%" bgcolor="#F3F2F1" align="center">
              <img border="0" src="<%=rs.getString("pd_photo_path")%>" width="85" height="66" align="left"></td>
              <td width="13%" bgcolor="#F3F2F1" align="left"><%=rs.getString("pd_name")%>&nbsp;</td>
