...
<tr>
  ...
  <tr>
    ...
    <table border="0" cellspacing="0" width="921" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111">
      <tr >
        
        <td bgcolor="#E8E8FF" height=500 valign="top" width="859">
        <p align="center">&nbsp;</p>
		...
		PreparedStatement stat = conn.prepareStatement("select * from order_table");
		...
		%>
            ...
            <tr>
              ...
              <td width="12%" bgcolor="#F3F2F1" align="left"><%=rs.getString("status")%>&nbsp;</td>
              <td width="12%" bgcolor="#F3F2F1" align="left"><%=rs.getString("status")%>&nbsp;</td>
